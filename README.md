...
프로젝트의 협업을 위해 Notion이나 GitHub와 같은 도구를 적극적으로 활용하여 팀원들과의 의사소통, 작업 일정 관리, 코드 버전 관리 등을 효과적으로 진행했습니다. 또한 구글 캘린더나 다음 주소와 같은 외부 API를 활용하여 사이트에 다양한 기능을 추가해 필요한 기능을 구현하고 사용자의 편의성을 증대시키는 것도 중요하다느 점을 알았습니다.
